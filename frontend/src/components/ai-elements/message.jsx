...
export const MessageContent = ({ children, className, ...props }) => (
	<div
		className={cn(
			...
			"group-[.is-assistnant]:ml-auto group-[.is-assistant]:rounded-lg group-[.is-assistant]:px-4 group-[.is-assistant]:py-3 group-[.is-assistant]:bg-secondary group-[.is-assistant]:text-foreground",
			className,
		)}
		{...props}
	>
